...
<head>
    ...
    <style>
        ...
        .story-card {{ display: flex; gap: 28px; margin-bottom: 56px; padding: 28px; align-items: center; border-radius: var(--radius-md); }}
        .story-card img {{ width: 240px; height: 170px; object-fit: cover; border-radius: var(--radius-sm); border: 2px solid rgba(255,215,0,0.4); box-shadow: 0 12px 30px rgba(0,0,0,0.5); }}
        .story-info h3 {{ font-family: var(--font-heading); font-size: 2.2rem; color: #fff; margin-bottom: 10px; }}
        .story-info p {{ color: var(--text-muted); font-size: 1.05rem; line-height: 1.6; }}
    </style>
</head>
<body class="theme-golden">
    ...
    <main class="page-hero">
        ...
        <p class="page-subtitle">Every chapter with you, Kamya, shines like a bright golden star.</p>
    </main>
    ...
    <section class="story-timeline">
        <div class="glass-card story-card tilt-card">
            ...
            <div class="story-info">
                <span style="color:var(--accent-gold); font-size:0.88rem; font-weight:600; text-transform:uppercase; letter-spacing:1px;">Chapter 01</span>
                <h3>The First Spark</h3>
                <p>When our paths crossed, it felt as though the stars aligned in perfect harmony. Your warmth instantly lit up my entire world.</p>
            </div>
        </div>
        ...
        <div class="glass-card story-card tilt-card">
            ...
            <div class="story-info">
                <span style="color:var(--accent-gold); font-size:0.88rem; font-weight:600; text-transform:uppercase; letter-spacing:1px;">Chapter 02</span>
                <h3>Endless Conversations</h3>
                <p>Laughter that echoed into late nights. Every detail you shared became my absolute favorite memory to keep.</p>
            </div>
        </div>
        ...
        <div class="glass-card story-card tilt-card">
            ...
            <div class="story-info">
                <span style="color:var(--accent-gold); font-size:0.88rem; font-weight:600; text-transform:uppercase; letter-spacing:1px;">Chapter 03</span>
                <h3>Unmatched Radiance</h3>
                <p>Capturing your grace in moments big and small. You look stunning effortlessly, inside and out.</p>
            </div>
        </div>
        ...
        <div class="glass-card story-card tilt-card">
            ...
            <div class="story-info">
                <span style="color:var(--accent-gold); font-size:0.88rem; font-weight:600; text-transform:uppercase; letter-spacing:1px;">Chapter 04</span>
                <h3>Quiet Sunset Walks</h3>
                <p>Hand in hand under golden evening skies. Watching the horizon with you made time stand completely still.</p>
            </div>
        </div>
    </section>
...
<head>
    ...
    <link rel="stylesheet" href="css/transitions.css">
    <style>
        .album-book {{ max-width: 800px; height: 450px; margin: 40px auto 100px auto; background: #faf6f0; border-radius: var(--radius-md); box-shadow: 0 30px 60px rgba(0,0,0,0.7); display: flex; overflow: hidden; position: relative; border: 4px solid #8b0032; }}
        ...
        .album-page-left img {{ width: 90%; height: 260px; object-fit: cover; border-radius: var(--radius-sm); border: 4px solid #fff; box-shadow: 0 10px 25px rgba(0,0,0,0.2); }}
        ...
        .btn-secondary {{ padding: 10px 20px; background: #8b0032; color: #fff; border: none; border-radius: var(--radius-full); cursor: pointer; }}
    </style>
</head>
<body class="theme-album">
    ...
    <div class="album-book" id="album-book">
        <div class="album-page-left">
            <img src="assets/images/kamya_11.jpg" id="album-img" alt="Album Page">
        </div>
    ...
    <script>
    const pages = [
        {{ img: 'assets/images/kamya_11.jpg', title: 'Pure Elegance', desc: 'A snapshot of timeless grace that fills my heart with joy every single time.' }},
        {{ img: 'assets/images/kamya_12.jpg', title: 'Golden Glow', desc: 'Warmth and laughter captured forever under the soft golden light.' }},
        {{ img: 'assets/images/kamya_13.jpg', title: 'Unmatched Charm', desc: 'Your gentle smile is my absolute favorite sight in the world.' }}
    ];
...
print(f"Generated ALL {len(html_pages)} HTML pages successfully!")
